...
namespace OpenTK.Window
{
    ...
    internal static partial class DpiCalculator
    {
        ...
        /// </remarks>
        public static unsafe bool TryGetMonitorDpi(MonitorHandle* monitor, out float horizontalDpi, out float verticalDpi)
        {
            if (TryGetFromCache((IntPtr)monitor, out DpiInfo info))
            {
        ...
        /// be scaled correctly.
        /// </remarks>
        public static unsafe bool TryGetMonitorDpiRaw(MonitorHandle* monitor, out float horizontalDpi, out float verticalDpi)
        {
            if (TryGetFromCache((IntPtr)monitor, out DpiInfo info))
            {
        ...
        public static unsafe MonitorHandle* GetMonitorFromWindow(WindowHandle* window)
        {
            if (!CheckCache())
            {
        ...
        private static unsafe void DpiMonitorCallback(MonitorHandle* monitor, ConnectedState state)
        {
