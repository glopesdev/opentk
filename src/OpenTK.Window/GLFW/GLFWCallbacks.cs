...
namespace OpenTK.Window.GraphicsLibrary
{
    ...
    public static unsafe class GLFWCallbacks
    {
        ...
        public delegate void DropCallback(WindowHandle* window, int count, byte** paths);
        ...
        public delegate void MouseButtonCallback(WindowHandle* window, MouseButton button, InputAction action, KeyModifiers mods); // TODO: Make enums for int params in callback
        ...
        public delegate void MonitorCallback(MonitorHandle* monitor, ConnectedState state);
        ...
        public delegate void WindowContentScaleCallback(WindowHandle* window, float xscale, float yscale);
