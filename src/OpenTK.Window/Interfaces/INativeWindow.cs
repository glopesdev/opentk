...
namespace OpenTK.Window
{
    ...
    public interface INativeWindow : IDisposable
    {
        ...
        /// <summary>
        /// Gets or sets a <see cref="Rectangle" /> structure the contains the external bounds of this window,
        ...
        /// <summary>
        /// Gets or sets a <see cref="Point" /> structure that contains the location of this window on the
        /// desktop.
        /// </summary>
        Point Location { get; set; }

        /// <summary>
        /// Gets or sets a <see cref="Point" /> structure that contains the external size of this window.
        /// </summary>
        Size Size { get; set; }

        /// <summary>
        /// Gets or sets a <see cref="Rectangle" /> structure that contains the internal bounds of this window,
        ...
        /// <summary>
        /// Gets a <see cref="Size" /> structure that contains the internal size this window.
        /// </summary>
        Size ClientSize { get; }
        ...
        /// <summary>
        /// Gets or sets the <see cref="OpenTK.Window.Input.MouseCursor" /> for this window.
        /// </summary>
