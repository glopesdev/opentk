...
namespace OpenTK.Window.Input
{
    ...
    public struct MouseState : IEquatable<MouseState>
    {
        ...
        /// </summary>
        /// <param name="button">The <see cref="OpenTK.Window.Input.MouseButton" /> to check.</param>
        ...
        /// <summary>
        /// Returns a <see cref="string" /> that represents the current <see cref="OpenTK.Window.Input.MouseState" />.
        /// </summary>
        /// <returns>A <see cref="string" /> that represents the current <see cref="OpenTK.Window.Input.MouseState" />.</returns>
