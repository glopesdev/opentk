...
namespace OpenTK.Window
{
    ...
    public readonly struct KeyboardKeyEventArgs
    {
        ...
        /// <summary>
        /// Gets a value indicating whether <see cref="OpenTK.Window.Input.KeyModifiers.Alt" /> is pressed.
        /// </summary>
        /// <value><c>true</c> if pressed; otherwise, <c>false</c>.</value>
        public bool Alt => Modifiers.HasFlag(KeyModifiers.Alt);

        /// <summary>
        /// Gets a value indicating whether <see cref="OpenTK.Window.Input.KeyModifiers.Control" /> is pressed.
        /// </summary>
        /// <value><c>true</c> if pressed; otherwise, <c>false</c>.</value>
        public bool Control => Modifiers.HasFlag(KeyModifiers.Control);

        /// <summary>
        /// Gets a value indicating whether <see cref="OpenTK.Window.Input.KeyModifiers.Shift" /> is pressed.
        /// </summary>
        /// <value><c>true</c> if pressed; otherwise, <c>false</c>.</value>
